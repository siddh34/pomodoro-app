...
const AboutUsPage: React.FC = () => {
    ...
    return (
        <>
                ...
                <div className="flex items-center justify-center p-4 m-4 col">
                    <a className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100">
                        ...
                        <h1 className="font-roboto-slab">
                            ...
                            "Pomodoros," which are designed to help people
                            become more productive and focused. During this time
                            the person can concentrate solely and without
                            interruption on one subject. Following the
                            completion of a Pomodoro, one takes a quick 5-minute
                            break to recuperate.
                        </h1>
                    </a>
                </div>
            ...
            <footer className="bg-white shadow md:flex md:items-center md:justify-between dark:bg-gray-800">
                <div className="w-full max-w-screen-xl p-4 mx-auto text-gray-500 md:flex md:items-center md:justify-center">
